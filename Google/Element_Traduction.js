function googleTranslateElementInit() {
    new google.translate.TranslateElement({
        pageLanguage: 'fr', 
        includedLanguages: 'ar,bg,en,es,it,ro,cs,de,pl', 
        layout: google.translate.TranslateElement.InlineLayout.HORIZONTAL
        }, 'traducteur');
}

(function(){
    var d=window,e=document,f=".",g="UTF-8",h="complete",k="head",l="link",m="script",n="stylesheet",p="text/css",q="text/javascript";
    Math.random();
    function r(b){
        ...
        function _isNS(b){
        b=b.split(f);
        for(var a=d,c=0;c<b.length;++c)if(!(a=a[b[c]]))return!1;return!0
        }
        function _setupNS(b){
        b=b.split(f);
    ...
    c._pah=h;
    c._pbi='images/motif.png';
    c._pci=b+'/translate_static/img/te_ctrl3.gif';
    c._phf=h+'/translate_static/js/element/hrs.swf';
    c._pli=b+'/translate_static/img/loading.gif';
    c._plla=h+'/translate_a/l';
    c._pmi=b+'/translate_static/img/mini_google.png';
    c._ps='Google/Element_De_Traduction.css';
    c._puh='translate.google.com';
    _loadCss(c._ps);
    _loadJs('Google/Translate_Google_Api.js');
})();