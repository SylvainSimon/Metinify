...
class Cron_Debannissement extends \PageHelper {
    ...
    public function run() {
        ...
        /* -------------------------------------------------------------------------------- */
        $Parametres_Selection_Enregistrements = $this->objConnection->prepare($Selection_Enregistrements);
        ...
        if ($Nombre_De_Resultat_Selection_Enregistrements != 0) {
            ...
            /* -------------------------------------------------------------------------------- */
            $Parametres_Selection_Enregistrements_Definitif = $this->objConnection->prepare($Selection_Enregistrements_Definitif);
