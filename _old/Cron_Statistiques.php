...
class Cron_Statistiques extends \PageHelper {
    ...
    public function run() {
        for ($e = 1; $e < 5; $e++) {
            ...
            $Parametres_Verification_Interval_Statistique = $this->objConnection->prepare($Verification_Interval_Statistique);
            ...
            if ($Donnees_Verification_Interval_Statistique->resultat_interval != 0) {
                ...
                $Recuperation_Donnees_Statistiques = "SELECT * 
                                          FROM site.statistiques_tampon
                                          WHERE type_stati = ?";
                $Parametres_Recuperation_Donnees_Statistiques = $this->objConnection->prepare($Recuperation_Donnees_Statistiques);
                ...
                $Parametres_Statistique_Nombres_Comptes = $this->objConnection->prepare($Statistique_Nombres_Comptes);
                ...
                $Parametres_Statistique_Nombres_Joueurs = $this->objConnection->prepare($Statistique_Nombres_Joueurs);
                ...
                $Parametres_Statistique_Nombres_Hommes = $this->objConnection->prepare($Statistique_Nombres_Hommes);
                ...
                $Parametres_Statistique_Nombres_Femmes = $this->objConnection->prepare($Statistique_Nombres_Femmes);
                ...
                $Parametres_Statistique_Nombres_Shinsoo = $this->objConnection->prepare($Statistique_Nombres_Shinsoo);
                ...
                $Parametres_Statistique_Nombres_Chunjo = $this->objConnection->prepare($Statistique_Nombres_Chunjo);
                ...
                $Parametres_Statistique_Nombres_Jinno = $this->objConnection->prepare($Statistique_Nombres_Jinno);
                ...
                $Parametres_Statistique_Nombres_Guerriers = $this->objConnection->prepare($Statistique_Nombres_Guerriers);
                ...
                $Parametres_Statistique_Nombres_Suras = $this->objConnection->prepare($Statistique_Nombres_Suras);
                ...
                $Parametres_Statistique_Nombres_Ninjas = $this->objConnection->prepare($Statistique_Nombres_Ninjas);
                ...
                $Parametres_Statistique_Nombres_Shamans = $this->objConnection->prepare($Statistique_Nombres_Shamans);
                ...
                $Parametres_Statistique_Nombres_Connexion = $this->objConnection->prepare($Statistique_Nombres_Connexion);
                ...
                $Parametres_Statistique_Nombres_Connexion_Unique = $this->objConnection->prepare($Statistique_Nombres_Connexion_Unique);
                ...
                $Requete_Suppression_Tampon_Statistique = "DELETE FROM site.statistiques_tampon
                                             WHERE type_stati = ?";
                $Preparation_Suppression_Tampon_Statistique = $this->objConnection->prepare($Requete_Suppression_Tampon_Statistique);
