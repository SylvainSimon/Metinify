                            ...
                            <table id="Table_Recherche_Joueurs" class="Table_Recherche_Joueurs Table_Recherches">
                                <thead>
                                    <tr>
                                        ...
                                        <th onclick="Declenchement_Recherche('player.last_play')" title="Trier par compte du joueur" class="Pointer Cellule_Compte">Dern. connection</th>
                                        <th onclick="Declenchement_Recherche('player.level')" title="Trier par niveau du joueur" class="Pointer Cellule_Level">Lvl.</th>
                                        <th onclick="Declenchement_Recherche('player.playtime')" title="Trier par yangs du joueur" class="Pointer Cellule_Yangs">Temps de jeu</th>
                    ...
                    <script type="text/javascript">
                        ...
                        function Declenchement_Recherche(param) {
                            ...
                            if ($("#Input_Rechercher_Joueurs").val().trim().length > 2) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "administration/ajax/SQL_Recherche_Joueurs.php",
