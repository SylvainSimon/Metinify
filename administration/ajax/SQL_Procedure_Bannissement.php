...
$Recuperation_Raison = "SELECT *
                        ...
                        AND id = :id_raison
                        LIMIT 1";
$Parametres_Recuperation_Raison = $Connexion->prepare($Recuperation_Raison);
...
<?php if ($Nombre_De_Resultat_Recuperation_Raison != 0) { ?>
    ...
    $Insertion_Logs = "INSERT INTO $BDD_Site.bannissements_actifs (id_compte, date_debut_bannissement, date_fin_bannissement, raison_bannissement, commentaire_bannissement, id_compte_gm, ip_gm, duree, definitif) 
