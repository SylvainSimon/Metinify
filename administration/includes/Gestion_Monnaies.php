                    ...
                    <div class="Conteneur_Tableau_Historiques_Monnaies">
                        <div class="Defilement_Tableau_Historiques_Monnaies">
                            ...
                            $Login = "SELECT account.login
                                                  ...
                                                  WHERE account.id = :id_compte
                                                  LIMIT 1";
                            $Parametres_Login = $Connexion->prepare($Login);
                            ?>

                            <?php
                            /* ------------------------ Historique Monnaies ---------------------------- */
                            $Historique_Gerer_Monnaies = "SELECT *
                                                          FROM $BDD_Site.administration_logs_gerer_monnaies
                                                          ORDER by date DESC
                                                          LIMIT 120";
                            $Parametres_Historique_Gerer_Monnaies = $Connexion->prepare($Historique_Gerer_Monnaies);
