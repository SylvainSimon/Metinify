...
class Pages_ClassementJoueurs_Recherche extends \PageHelper {
        ...
        <?php } else { ?>
            ...
            <?php while ($Donnees_Classement_Joueurs_Recherche = $Parametres_Classement_Joueur_Rechercher->fetch()) { ?> 
                ...
                <?php } else { ?>
                    ...
                    <td>
                        <?php echo $Donnees_Classement_Joueurs_Recherche->victimes_pvp; ?>
                    </td>
...
$class = new Pages_ClassementJoueurs_Recherche();
$class->run();
