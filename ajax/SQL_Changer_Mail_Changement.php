...
$Parametres_Insertion_Logs_Changement_Mail = $Connexion->prepare($Insertion_Logs_Changement_Mail);
...
$Parametres_Delete_Changement_Mail = $Connexion->prepare($Delete_Changement_Mail);
