...
class SQL_Changer_Mail_EnvoieMail extends \PageHelper {
    ...
    public function run() {
        ...
        $Insertion_Changement_Mail = "INSERT site.changement_mail (id_compte, compte, email, numero_verif, date, ip) 
...
$class = new SQL_Changer_Mail_EnvoieMail();
$class->run();
