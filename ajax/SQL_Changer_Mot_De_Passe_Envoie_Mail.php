...
if ($Nombre_De_Resultat == 1) {
    ...
    $Delete_Demande_Changements = "DELETE 
                               FROM $BDD_Site.changement_mot_de_passe
    ...
    $Insertion_Changement_Mail = "INSERT $BDD_Site.changement_mot_de_passe (id_compte, compte, nouveau_mot_de_passe, numero_verif, date, ip) 
