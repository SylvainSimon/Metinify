...
if ($Nombre_De_Resultat != 0) {
    ...
    $Parametres_Update_Mot_De_Passe_Verif = $Connexion->prepare($Update_Mot_De_Passe_Verif);
    ...
    $Parametres_Delete_Changement_Mail = $Connexion->prepare($Delete_Changement_Mot_De_Passe);
