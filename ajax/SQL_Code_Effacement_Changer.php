...
class SQL_Code_Effacement_Changer extends \PageHelper {
    ...
    public function run() {
        ...
        if ($Nombre_De_Resultat != 0) {
            ...
            $Parametres_Changer_Code_Effacement = $this->objConnection->prepare($Changer_Code_Effacement);
...
$class = new SQL_Code_Effacement_Changer();
$class->run();
