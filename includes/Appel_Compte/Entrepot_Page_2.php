        ...
        <?php if ($Nombre_De_Resultat_Case > 0) { ?>
            ...
            <?php if ($Nombre_De_Resultat_Chercher_Chemin > 0) { ?>
                ...
                <div class="Interieur_Case">
                    <img data-tooltip="" data-tooltip-track="1" id="cade_id_<?php echo $Donnees_Case->item_id; ?>" src="<?php echo $Resultat_Chercher_Chemin->chemin; ?>" style="position: absolute;cursor: default;" />
                    <?php
