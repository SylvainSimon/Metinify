<div id="Historiques_Achats">
    ...
    <table id="Tableau_Recapitulatif_Achats">
        <tr>
            <th colspan="2">Récapitulatif :</th>
        </tr>
        <tr>
            <td title="Nombres de paiements que vous avez effectué" class="Colonne_Gauche">Nombre d'achats :</td>
            <td><?= $Nombre_De_Resultat_Liste_Achats; ?></td>
        </tr>
        <tr>
    ...
    <div class="Zone_Tableau_Achats">
        <table id="Tableau_Achats">
