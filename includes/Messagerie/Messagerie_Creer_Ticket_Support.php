...
$Ticket_En_Attente = "SELECT numero_discussion
                          ...
                          WHERE id_compte = ?";
$Parametres_Ticket_En_Attente = $Connexion->prepare($Ticket_En_Attente);
...
$Parametres_Ticket_En_Traitement = $Connexion->prepare($Ticket_En_Traitement);
...
<div class="Zone_Message">
    ...
    <?php } else { ?>
        ...
        $Parametres_Mots_Bannis = $Connexion->prepare($Mots_Bannis);
        ...
        <form type="POST" action="javascript:void(0)" id="Formulaire_Nouveau_Ticket">
            ...
            <table class="Tableau_Creation_Ticket">
                    ...
                    <td>
                        <select onchange="Objet_selectionner();" id="Selecteur_Objet_Ticket" name="Selecteur_Objet_Ticket">
                            ...
                            $Liste_Objets = "SELECT objets 
                                         ...
                                         ORDER by objets ASC";
                            $Parametres_Liste_Objets = $Connexion->prepare($Liste_Objets);
                ...
                <tr>
                    <td colspan="3">
                        <textarea maxlength="1024" id="Textarea_Nouveau_Ticket" class="Textarea_Nouveau_Ticket" onblur="Longueur_minimal(); Fonction_Remplacement(this.value);" onkeyup="document.getElementById('Nombre_Caracteres_Nouveau_Ticket').innerHTML = (this.value.length + this.value.replace(/[^\n]+/g, '').length);"></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
