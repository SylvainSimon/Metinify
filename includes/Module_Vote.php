...
<?php if ($Nombre_De_Resultat_Recuperation_Site_De_Vote != 0) { ?>
    ...
    <div class="Menu_Sidebar">
        <div class="Menu_Sidebar_Haut Pointer No_Select" onclick="Slider_Sidebar_Droite_3();">Votez pour VamosMt2</div>
        <div class="Menu_Sidebar_Milieu" id="Div_Sidebar_Droite_3" style="">
            <?php while ($Donnees_Recuperation_Site_De_Vote = $Parametres_Recuperation_Site_De_Vote->fetch()) { ?>
               ...
               <input title="Voter et gagner 20 Vamonaies" class="Bouton_De_Vote" type="button" onclick=" Ajax(Verification_Connection_Vote(<?php echo $Donnees_Recuperation_Site_De_Vote->id_site_vote ?>)); window.open('<?php echo $Donnees_Recuperation_Site_De_Vote->lien_site_vote; ?>');" value="Voter sur <?php echo $Donnees_Recuperation_Site_De_Vote->nom_site_vote; ?> " />
<?php } ?>
        </div>
    </div>
<?php } ?>