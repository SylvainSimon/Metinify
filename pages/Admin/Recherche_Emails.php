...
class Recherche_Emails extends \PageHelper {
                ...
                <?php if ($Donnees_Recuperation_Droits->recherche_comptes == 1) { ?>
                    ...
                    <div class="box box-default flat">
                        ...
                        <div class="box-header">
                            <h3 class="box-title">Recherche d'emails</h3>
                        </div>
                    ...
                    <script type="text/javascript">
                        ...
                        function Declenchement_Recherche(param) {
                            ...
                            if ($("#Input_Rechercher_Joueurs").val().trim().length > 2) {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "pages/Admin/ajax/SQL_Recherche_Emails.php",
