    ...
    <div class="box-body no-padding hidden-sm hidden-xs">
        ...
        <table class="table table-condensed" style="border-collapse: collapse;">
            <?php if ($Donnees_Recuperation_Droits->gerer_monnaies == 1) { ?>
                <tr data-fancybox-type="iframe" class="fancybox_monnaies" href="pages/Admin/includes/Gestion_Monnaies.php"><td>- Gestion des monnaies</td></tr>
            ...
            <?php if ($Donnees_Recuperation_Droits->gerer_news == 1) { ?>
                <tr data-fancybox-type="iframe" class="fancybox_news" href="pages/Admin/includes/Gestion_News.php"><td>- Gestion des news</td></tr>
