...
<?php if (!empty($_GET["id"])) { ?>
    ...
    $Recuperation_Compte = "SELECT * FROM $BDD_Account.account
                                  WHERE id = ?
                                  LIMIT 1";
    $Parametres_Recuperation_Compte = $Connexion->prepare($Recuperation_Compte);
    ...
    $Recuperation_Bannissement = "SELECT bannissements_actifs.date_debut_bannissement,
                              ...
                              LIMIT 1";
    $Parametres_Recuperation_Bannissement = $Connexion->prepare($Recuperation_Bannissement);
