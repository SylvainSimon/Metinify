...
<div class="Cadre_Principal">
    ...
    <div class="Cadre_Principal_Haut Pointer No_Select" onclick="Slider_Cadre_Principal_1();">                  
        <h1>Classement arène pve des joueurs</h1>
    </div>
            ...
            <div>
                <div class="Position_Bouton_Precedent Bold">
                    <?php if ($Numero_De_Page >= 1) { ?>
                        <a href="javascript:void(0)" onclick="Ajax_Classement('ajax/Pages_ClassementJoueurs_PvE.php?page=<?php echo ($Numero_De_Page - 1); ?>')"><= Précédente</a>
                    <?php } else { ?>
                        <= Précédente
                    <?php } ?>
                </div>
                ...
                <div class="Position_Bouton_Suivant Bold">
                    <?php if ($Numero_De_Page <= $nombredePage) {
                        ?>
                        <a href="javascript:void(0)" onclick="Ajax_Classement('ajax/Pages_ClassementJoueurs_PvE.php?page=<?php echo ($Numero_De_Page + 1); ?>')">Suivante =></a>
                    <?php } else { ?>
                        Suivante =>
                    <?php } ?>
                </div>
