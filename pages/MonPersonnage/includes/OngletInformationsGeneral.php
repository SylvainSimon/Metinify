        ...
        <div class="col-lg-4">
            ...
            <table class="table table-condensed" style="border-collapse: collapse;">
                <tr>
                    ...
                    <td style="border-top: 0px;">
                        <a title="Aller sur la page du compte" href="javascript:void(0)" onclick="Ajax('pages/MonCompte/modules/MonCompte.php?id=<?php echo \Encryption::encryptForUrl($Donnees_Appel_Joueurs_Page->account_id); ?>')" rel="superbox[iframe]">
