...
$Verification_Concours_Ip = "SELECT ip FROM site.concours
                            ...
                            LIMIT 1";
$Parametres_Verification_Concours_Ip = $Connexion->query($Verification_Concours_Ip);
...
$Verification_Concours = "SELECT compte FROM site.concours
                            ...
                            ";
$Parametres_Verification_Concours = $Connexion->query($Verification_Concours);
...
$Paremetres_Insertion2 = $Connexion->prepare($Insertion_Logs2);
