<nav id="mainnav">
    <ul class="sidebar-menu">
        ...
        <?php } else { ?>
            <li id="Menu_Inscription_MonCompte" class="pointer"><a id="Lien_Mon_Compte" onclick="Ajax('pages/MonCompte/modules/MonCompte.php?id=<?php echo $_SESSION['ID']; ?>')">Mon compte</a></li>
        ...
        <?php } else { ?>
            <li id="Menu_Telechargement_ItemShop" class="pointer" style="display: inline;"><a id="Lien_Item_Shop" onclick="Ajax('pages/ItemShop/ItemShop.php?id=<?php echo $_SESSION['ID']; ?>')">Item-Shop</a></li>
